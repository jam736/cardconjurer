...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	// });
	loadBottomInfo({
		topLeft: {text:'Illus. {elemidinfo-artist}', x:0.1, y:1894/2100, width:0.8, height:0.0267, oneLine:true, size:0.0267, align:'left', shadowX:0.0021, shadowY:0.0015, color:card.bottomInfoColor},
		midLeft: {text:'{elemidinfo-set} \u2022 {elemidinfo-rarity} \u2022 {kerning3}{elemidinfo-number}{kerning0}', x:0.1, y:1941/2100, width:0.8, height:0.0267, oneLine:true, size:0.0171, align:'left', shadowX:0.0021, shadowY:0.0015, color:card.bottomInfoColor},
		note: {text:'{elemidinfo-note}', x:0.1, y:1980/2100, width:0.8, height:0.0267, oneLine:true, size:0.0171, align:'left', shadowX:0.0021, shadowY:0.0015, color:card.bottomInfoColor}
	});
}
